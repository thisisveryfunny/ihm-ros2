...
export const speedService = USE_MOCK ? new MockSpeedService() : new MockSpeedService(); // TODO: replace with ROS2SpeedService

export const imuService = USE_MOCK ? new MockImuService() : new MockImuService(); // TODO: replace with ROS2ImuService

export const batteryService = USE_MOCK ? new MockBatteryService() : new MockBatteryService(); // TODO: replace with ROS2BatteryService
